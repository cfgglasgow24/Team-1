...
def quiz():
    ...
    options_storage["random letters"] = list(map(chr, random.sample(range(65, 65+26), 2)))
    options_storage["left or right"] = random.randrange(2)  # 0 = left, 1 = right
    options_storage["correct letter"] = options_storage["random letters"][options_storage["left or right"]]
    ...
    options_storage["captions"] = {'A': 'touch the end of their thumb with your right forefinger.',
                                   ...
                                   'C': 'draw your right forefinger down their thumb and along the top of the '
                                        'outstretched forefinger.',
                                   'D': 'place the thumb and forefinger of your right hand (other fingers tucked '
                                        'away) on the forefinger of their left hand.',
                                   'E': 'touch the end of their forefinger with your right forefinger.',
                                   'F': 'place your forefinger and middle finger at right angles to their '
